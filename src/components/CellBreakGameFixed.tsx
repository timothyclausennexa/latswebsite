...
function CellBreakGameFixed({ onAuthClick, onOpenShop, onGameEnd }: GameProps) {
    ...
    const endGame = useCallback(async () => {
        ...
        // Auto-submit score and award lats if user is logged in
        ...
        if (!user) {
            ...
            try {
                ...
                // Use the database function that handles both score submission and lats awarding
        ...
        <div className="relative aspect-video w-full border-2 border-warning-orange bg-black">
            ...
            {gameState === 'idle' && (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 p-4">
                    <h2 className="text-4xl font-bold text-warning-orange mb-2">LATS BREAK</h2>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/80 p-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl">
                        ...
                        >
                            ...
                            <p className="text-sm text-ash-white/80">Earn LATS by surviving</p>
