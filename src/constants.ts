...
export const FAQ_DATA: FaqItem[] = [
    { question: "What the hell is this?", answer: "It's a live social experiment. Lats is bound to a 24/7 entertainment livestream. The community controls the length of his 'sentence' by buying and selling the $LATS token. Buying adds time, selling reduces it. Freedom is when the timer hits zero." },
...
export const DETAILED_ROADMAP_DATA: Milestone[] = [
    // --- ACT I: THE GRIND ---
    { marketCap: "$30k MCAP", description: "Lats eats 50 Warheads candies with NO water on stream. The pain begins." },
    { marketCap: "$50k MCAP", description: "Lats drinks an ENTIRE bottle of hot sauce on stream. Choose your poison, community." },
    { marketCap: "$100k MCAP", description: "DEX fee paid. The token is officially on Raydium." },
    { marketCap: "$125k MCAP", description: "Lats attempts to eat 10 ghost peppers in under 5 minutes." },
    { marketCap: "$150k MCAP", description: "First wave of 50 paid boosts are launched." },
    { marketCap: "$175k MCAP", description: "24-hour karaoke marathon - community picks every song." },
    { marketCap: "$200k MCAP", description: "Second wave of 100 paid boosts are launched." },
    { marketCap: "$250k MCAP", description: "Lats gets waxed live on stream - community chooses the pattern." },
    { marketCap: "$300k MCAP", description: "Ice bath challenge: Must stay submerged for 10 minutes." },
    { marketCap: "$350k MCAP", description: "Lats shaves his head completely on stream." },
    { marketCap: "$400k MCAP", description: "Community Giveaway Round 1: MacBook Pro & 2 iPhones (live wheel)." },
    { marketCap: "$450k MCAP", description: "1,000 burpee challenge - must complete in under 2 hours." },
    { marketCap: "$500k MCAP", description: "Lats prints and places 1,500 QR codes across his city for a scavenger hunt." },
    { marketCap: "$550k MCAP", description: "Live cooking stream: Must recreate Gordon Ramsay's beef wellington blindfolded." },
    { marketCap: "$600k MCAP", description: "Community controls Lats' diet for 48 hours via polls." },
    { marketCap: "$650k MCAP", description: "Lats learns and performs a stand-up comedy routine live." },
    ...
    { marketCap: "$800k MCAP", description: "Lats attempts 100 consecutive push-ups. Fails = starts over." },
    { marketCap: "$850k MCAP", description: "Mystery box challenge: Eat whatever the community sends (within reason)." },
    { marketCap: "$900k MCAP", description: "Lats must speak only in rhymes for 24 hours straight." },
    { marketCap: "$950k MCAP", description: "Community picks Lats' entire wardrobe from thrift stores - must wear for a week." },
    { marketCap: "$1M MCAP", description: "Lats must wear a ridiculous costume chosen by the community for 24 hours straight." },
    { marketCap: "$3M MCAP", description: "24-hour 'no-sleep' challenge. Every yawn adds 1 hour to the sentence." },
    ...
    { marketCap: "$200M MCAP", description: "Lats must learn and perform a full magic show on stream." },
    ...
    { marketCap: "$750M MCAP", description: "Lats has to build a full-scale IKEA furniture set on stream, blindfolded." },

    // --- ACT II: EXPANSION & POWER ---
    { marketCap: "$1B MCAP", description: "SEASON 2 BEGINS. Sells are now 3x more effective. The game changes." },
    { marketCap: "$1.2B MCAP", description: "Billboard Campaign Across America. We attempt to get $LATS in every major US city." },
    { marketCap: "$1.5B MCAP", description: "World Tour Part 1: Lats travels to meet other memecoin creators and communities." },
    { marketCap: "$1.8B MCAP", description: "The 'Lats Millionaire' event: A random token holder with over $1000 worth is sent enough to become a millionaire." },
    { marketCap: "$2.1B MCAP", description: "Sponsor a UFC fighter or a professional esports team." },
    { marketCap: "$2.4B MCAP", description: "Purchase the first 'LATS Community Estate', a property for holders to visit." },
    { marketCap: "$2.8B MCAP", description: "The American Talaria Run: Lats travels from California to New York on an e-bike, with community challenges along the way." },
    { marketCap: "$3B MCAP", description: "Purchase a Lamborghini Huracan, wrap it in $LATS branding, and give it away to a random holder." },
    { marketCap: "$3.5B MCAP", description: "Global Billboard Campaign: We target London, Tokyo, and Dubai." },

    // --- THE GRIND TO THE ENDGAME ---
    { marketCap: "$3.8B MCAP", description: "Host a music festival sponsored by $LATS." },
    { marketCap: "$4.1B MCAP", description: "Launch a community-governed treasury (DAO) to fund holder ideas." },
    { marketCap: "$4.4B MCAP", description: "Second 'Lats Millionaire' event." },
    ...
    { marketCap: "$7B MCAP", description: "Third 'Lats Millionaire' event." },
...
export const MOCK_LIVE_EVENTS: LiveEvent[] = [
    ...
    { id: 4, type: 'event', description: 'Lats fell asleep!', timestamp: '5m ago', amount: 166.7 }, // 10,000/60
